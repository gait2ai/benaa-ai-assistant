...
class ResponseCache:
    ...
    def _generate_key(self, prompt, model, system_prompt, temperature, max_tokens):
    ...
    def get(self, prompt, model, system_prompt, temperature, max_tokens):
        """Get a response from the cache if it exists and is not expired."""
        key = self._generate_key(prompt, model, system_prompt, temperature, max_tokens)
    ...
    def set(self, prompt, model, system_prompt, temperature, max_tokens, response):
    ...
    async def generate(self, 
        ...
        for current_model in models_to_try:
            try:
                ...
                # Make API request with async context manager
